    ...
    pokemons.forEach(function (pokemon) {
      ...
      const fila = $("<tr></tr>");
        ...
        $.get(pokemon.url, function (pokemon) {
            ...
            const imgCelda = $("<td></td>");
            const imagen = $("<img>")
                .attr("src", pokemon.sprites.front_default)    // Establecemos la URL de la imagen como src
                .attr("width", "100")                         // Establecemos el ancho de la imagen
                .attr("height", "100");                       // Establecemos la altura de la imagen

            imgCelda.append(imagen);


            fila.append(imgCelda);
        });
